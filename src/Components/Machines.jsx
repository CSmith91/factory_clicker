...
const Machines = ({ machineType, ores, oreName, ingredients,  setOres, setIngredients, storage, getStorage, handleMachineChange, pendingMachineOutput, setPendingMachineOutput, outputCounts, updateOutputCount, onAlert }) => {
